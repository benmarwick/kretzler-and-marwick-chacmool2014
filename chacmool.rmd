...
# five journals data
load("F:/My Documents/My Papers/conferences/Chacmool2014/unpack_multi.RData")
```
...
length(no_gen_articles[,1]) # number of articles containing "gender"
no_feminist_articles<-subset(feminism, feminism[,2] >0)
length(no_feminist_articles[,2]) # number of articles containing "feminism"
no_feminism_articles<-subset(feminism, feminism[,3] >0)
length(no_feminism_articles[,3]) # number of articles containing "feminist"
```
